    ...
    <?php $i=1;foreach ($booking as $row) { ?>
       <!-- --><?php /*if($row['user_role']=="user") {*/?>
            <tr>
                ...
                <td><?php $x=$this->user_model->list_sector_byid($row['sector']); echo $x['sec_name'];?>  </td>
                <td><?php $x=$this->user_model->list_plot_byid($row['plot_id']); echo $x['plot_no'];?>  </td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table class="table table-responsive">
                                        ...
                                        <tr><th>Block</th><td><?php $x=$this->user_model->list_sector_byid($row['sector']); echo $x['sec_name'];?> </td></tr>
                                        <tr><th>Plot</th><td><?php $x=$this->user_model->list_plot_byid($row['plot_id']); echo $x['plot_no'];?> </td></tr>
