    ...
    <div class="sidebar-menu">
        ...
        <div class="sidebar-menu-inner">
            ...
            <header class="logo-env">
             ...
             <div class="logo">
                    <a href="index.html">
                        <img class="logo" src="<?php echo base_url(); ?>assets/images/logo1.png" width="60" alt="">
...
<!--                <li class="root-level">
                    <a onclick="loadview('block')">
                        <i class="entypo-menu"></i>
                        <span class="title">Add Block</span>
                    </a>
                </li>
                <li class="root-level">
                ...
                <li class="has-sub root-level">
                    <a >
                        ...
                        <span class="title">Block Wise Plot</span>
                    </a>
                    <ul style="opacity: 0.2; height: 0px;">
                        <?php $all_sec=$this->user_model->list_sector();  ?>
                ...
                <li class="root-level">
                    <a onclick="loadview('genealogy/<?php echo $_SESSION['user_id']; ?>')">
                ...
                <!--=========================-->
                <li class="root-level">
                    <a onclick="loadview('reward_history/<?php echo $_SESSION['user_id'];  ?>')">
                        <i class="entypo-heart"></i>
                        <span class="title">Reward </span>
                    </a>
                </li>
                <li class="root-level">
                    <a onclick="loadview('promotiom_history/<?php echo $_SESSION['user_id'];  ?>')">
                        <i class="entypo-tag"></i>
                        <span class="title">Promotion</span>
                    </a>
                </li>
                <li class="root-level">
                    <a onclick="loadview('commission/<?php echo $_SESSION['user_id'];  ?>')">
