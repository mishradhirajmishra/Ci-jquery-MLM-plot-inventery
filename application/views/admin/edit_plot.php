...
<h1 class="page-title">Update Plot </h1>
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('edit_plot/<?php echo $plot['plot_id']; ?>')">Page Refresh</a></h6>
<hr>
<!--=====================================-->
<?php // print_r($plot)?>
<br>
       ...
       <!-- <div id="subsmsg"></div>-->
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('admin/update_plot',$data) ?>
                <br>
                ...
                <!--=====================================-->
                   <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <select class="form-control" name="sr_no" disabled>
                            <?php foreach ( $block as $row) { ?>
                                <option  value="<?php echo $row["sec_id"]?>" <?php if($row["sec_id"]==$plot['sr_no']){echo "selected";}?>><?php echo $row['sec_name']?></option>
                            <?php }?>
                        </select>
                    </div>
                   </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" class="form-control" name="plot_no" value="<?php echo $plot['plot_no']?>" disabled>
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" class="form-control" name="plot_size"  value="<?php echo $plot['plot_size']?>">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/admin/update_plot',
                ...
                success: function(msg){
                    if(msg==1) {
                        ...
                        loadview('all_plot/<?php echo $plot["sr_no"];?>');
                    }else{
                        ...
                        loadview('edit_plot/<?php echo $plot['plot_id']; ?>');
                    }
