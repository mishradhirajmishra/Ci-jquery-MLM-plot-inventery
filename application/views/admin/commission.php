    ...
    <div class="col-sm-10 col-sm-offset-1">
       <!-- <div id="subsmsg"></div>-->
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                <?php $customer=$this->admin_model->all_booking_by_sponser_id( $sponser['user_id']); ?>
                <table class="table table-responsive">
                    ...
                    <?php $total_direct_commission=0; foreach ($customer as $row){  //print_r($row)?>
                        ...
                        <tr><td><?php echo $row['user_name']; ?></td><td><?php echo $row['sponser_id']; ?></td><td>
                                <?php $x=$this->admin_model->associate_commission_m( $row['id'],$row['sponser_id']); echo $x; $total_direct_commission += $x; ?>
                            </td></tr>
                    <?php } ?>
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body"> <?php $total_ind= 0;?>
                <?php $under_associate=$this->admin_model->all_under_associate_by_sponser_id( $sponser['user_id']); ?>
                <table class="table table-responsive">
                    ...
                    <tr><td><?php echo $row['user_name'];?></td>
                        ...
                        <td>
                            <?php  $x = $this->admin_model-> total_commission($row['user_id'],$row['user_role']);
                          echo $x;?>

                        </td>
                        <td><?php $x=$this->admin_model->list_user_role_by_id($row['user_role']); echo $x['name'];?></td>

                        <td>
                            <!--=================================================-->
                            <?php  $x = $this->admin_model-> total_indirect_commission($row['user_id'],$row['user_role'],$sponser['user_role']);
                            $total_ind += $x;  echo $x;?>
                            <!--=================================================-->
                        </td>
                    </tr>
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                <?php  $commis = $this->admin_model->all_commission($sponser['user_id']);?>
                <table class="table table-responsive" >
