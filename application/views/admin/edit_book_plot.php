...
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('edit_booking/<?php echo $booking['id'] ?>')">Page Refresh</a></h6>
<hr>
<!--=====================================-->
<?php //print_r($booking);?>
<div class="guardian">
       ...
       <!-- <div id="subsmsg"></div>-->
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('admin/update_plot_booking',$data) ?>
                <br>
                    ...
                    <div class="col-xs-8">
                        <select name="sector" id="sec_id" class="form-control" onchange="myFunction(value)" required="required">
                            ...
                            <?php foreach ($sec as $row) { ?>
                                <option value="<?php echo $row['sec_id'] ?>" <?php if($booking['sector']==$row['sec_id']) echo 'selected'; ?> ><?php echo $row['sec_name'] ?> </option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <select name="plot_id" id="plot" class="form-control" required="required" onchange="getPlotsize(this.value)" >
                            <option value="<?php echo $booking['plot_id'] ?>"><?php $x=$this->admin_model->list_plot_byid($booking['plot_id']); echo $x['plot_no'];?>  </option>
                        </select>
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="number" id="plot_size" class="form-control" required="required" value="<?php echo $x['plot_size'];?>" disabled>                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    <label class="col-xs-4">Plot Rate :</label>
                    <div class="col-xs-8">
                        <?php $rate = $booking['total_price']/($booking['plc']*$x['plot_size']); //echo $rate; ?>
                        <select id="plot_rate"  class="form-control" required="required" onblur="remove_plot_price()">
                            <option >Sellect </option>
                            <option value="800" <?php if($rate=='800') echo 'selected'; ?> >800</option>
                            <option value="1000" <?php if($rate=='1000') echo 'selected'; ?> >1000</option>
                        </select>
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <select name="plc" class="form-control" required="required" onchange="getPlotPrice(this.value)">
                            <option >Sellect </option>
                            <option value="1.1" <?php if($booking['plc']=='1.1') echo 'selected'; ?>>Yes</option>
                            <option value="1" <?php if($booking['plc']=='1') echo 'selected'; ?>>No</option>
                        </select>
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="number" id="total_price" name="total_price" value="<?php echo $booking['total_price'] ?>" placeholder="" class="form-control" required="required" diabled>
                    </div>
                </div>
                <!--=====================================-->
<!--                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <select name="emi_time" class="form-control">
                            <option value="36" <?php if($booking['emi_time']=='36') echo 'selected'; ?>>3 Year </option>
                            <option value="60" <?php if($booking['emi_time']=='60') echo 'selected'; ?>>5 Year</option>
                        </select>
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <select name="payment_mode" class="form-control">
                            <option value="cash" <?php if($booking['payment_mode']=='cash') echo 'selected'; ?>>Cash</option>
                            <option value="cheque" <?php if($booking['payment_modecheque']=='cash') echo 'selected'; ?>>Cheque</option>
                        </select>
                    </div>
                </div>
...
<!--                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="number" value="<?php /*echo $booking['sponser_id'] */?>" id="sponser_id" class="form-control" name="sponser_id"  required onblur="finddetail(value)" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        ...
                        <input type="text" class="form-control" name="user_name"  required value=" <?php echo $booking['user_name'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-4">Customer Father's Name :</label>
                    <div class="col-xs-8">
                        <input type="text" class="form-control" name="father_name"  required value=" <?php echo $booking['father_name'] ?>">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        ...
                        <input type="tel" class="form-control" name="user_phone"  required  value=" <?php echo $booking['user_phone'] ?>">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="email" class="form-control" name="user_email" value=" <?php echo $booking['user_email'] ?>" required >
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" class="form-control" name="user_address" value=" <?php echo $booking['user_address'] ?>" >
                    </div>
                </div>
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php /*echo base_url()*/?>index.php/admin/update_plot_booking',
                ...
                success: function(msg){
                    if(msg==1) {
                        ...
                        loadview('edit_booking/<?php echo $booking['id'] ?>');
                    }else{
