...
<div class="col-sm-12" id="guardian">
    ...
    <table class="table table-responsive">
        ...
        <tr><th>Block</th><td style="text-align: center"><?php $x=$this->admin_model->list_sector_byid($booking['sector']); echo $x['sec_name'];?> </td></tr>
        <tr><th>Plot</th><td style="text-align: center"><?php $x=$this->admin_model->list_plot_byid($booking['plot_id']); echo $x['plot_no'];?> </td></tr>
