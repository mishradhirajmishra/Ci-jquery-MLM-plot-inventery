...
<table id="example" >
    ...
    <?php foreach ($booking as $col) { ?>
            ...
            <tr>
                ...
                <td><?php $x=$this->admin_model->list_plot_byid($col['plot_id']); echo $x['plot_no'];?> </td>
                <td><?php echo $col['user_name'];?></td>
                <td><?php  $amt=$this->admin_model->booking_amt($col['id']); $ins=round(($col['total_price']-$amt)/$col['emi_time']); echo $ins; ?></td>
