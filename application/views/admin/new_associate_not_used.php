...
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('new_associate')">Page Refresh</a></h6>
<hr>
<!--=====================================-->
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="number" class="form-control" name="sponser_id"  required onblur="findroal(value)">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        ...
                        <input type="text" class="form-control" name="login_id"  required  onblur="check_login_id(value)">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
