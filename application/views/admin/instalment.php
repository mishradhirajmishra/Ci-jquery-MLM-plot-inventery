...
<div class="guardian">
    ...
    <div class="col-sm-6">
       <!-- <div id="subsmsg"></div>-->
        <?php $r=$booking['total_price']-$total; if($r>0 && $paid==0){ ?>
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('admin/pay_installment',$data) ?>
                 <input type="hidden" name="cust_id" value="<?php echo $booking['id'] ?>">
                 <input type="hidden" name="sponser_id" value="<?php echo $booking['sponser_id'] ?>">
                 <input type="hidden" name="sponser_role" value="<?php echo $booking['sponser_role'] ?>">
                <!--=====================================-->
                <!--=====================================-->
                <div class="form-group">
                    <label class="col-xs-3">Instalment :</label>
                    <div class="col-xs-6">
                        <input type="number" name="stalment" class="form-control" required="required" value="<?php echo $intalment;?>" >
                    </div>
                    <div class="col-xs-3">
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <table class="table table-responsive">
                ...
                <tr><th>Block</th><td><?php $x=$this->admin_model->list_sector_byid($booking['sector']); echo $x['sec_name'];?> </td></tr>
                <tr><th>Plot</th><td><?php $x=$this->admin_model->list_plot_byid($booking['plot_id']); echo $x['plot_no'];?> </td></tr>
