...
<script type="text/javascript">
    ...
    {        // JVector Maps
        ...
        // Donut Chart
        <?php $a=$this->admin_model->total_plot(); ?>
        <?php $s=$this->admin_model->total_sold_plot();?>
        var bp=<?php echo $a;?>;
        var ap=<?php echo $a-$s;?>;
...
<hr>
    <div class="col-sm-6"  style="display: none">
        ...
        <!---->
        <div id="donut-chart-demo" class="morrischart" style="height: 255px;"></div>
            </div></div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-xs-7">
          <!--  <h5 class="page-title" style="text-align:right;font-weight: bold;color: #421e02;margin: 0px"> <?php /*echo($year); */?></h5>-->
        </div>
        <!--=====================================-->
        <!--end panal body-->
        <br>    <br>
