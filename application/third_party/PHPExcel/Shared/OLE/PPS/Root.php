...
class PHPExcel_Shared_OLE_PPS_Root extends PHPExcel_Shared_OLE_PPS
{
    ...
    */
    public function save($filename)
    {
        ...
        // Write PPS
        $this->_savePps($aList);
        // Write Big SectorDepot and BDList and Adding Header informations
    ...
    */
    ...
    /**
    * Helper function for caculating a magic value for Sectorsizes
    *
    * @access public
    ...
    */
    public function _saveHeader($iSBDcnt, $iBBcnt, $iPPScnt)
    {
        ...
        fwrite(
            ...
            . pack("V", 0)
            . pack("V", 0x1000)
            . pack("V", $iSBDcnt ? 0 : -2) //Small SectorDepot
            . pack("V", $iSBDcnt)
        );
    ...
    */
    public function _saveBbd($iSbdSize, $iBsize, $iPpsCnt)
    {
        ...
        if (($iAllW + $iBdCnt) % $iBbCnt) {
            $iSector= ($iBbCnt - (($iAllW + $iBdCnt) % $iBbCnt));
            for ($i = 0; $i < $iBlock; ++$i) {
                fwrite($FILE, pack("V", -1));
            }
        }
