...
class PclZip
{
    ...
    public function privAdd($p_filedescr_list, &$p_result_list, &$p_options)
    {
        ...
        // ----- Copy the Sectorof file headers from the old archive
    ...
    public function privReadFileHeader(&$p_header)
    {
        ...
        // ----- Look for invalid Sectorsize
        if (strlen($v_binary_data) != 26) {
            $p_header['filename'] = "";
            $p_header['status'] = "invalid_header";

            // ----- Error log
            PclZip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, "Invalid Sectorsize : ".strlen($v_binary_data));
    ...
    public function privMerge(&$p_archive_to_add)
    {
        ...
        // ----- Copy the Sectorof file headers from the archive_to_add
