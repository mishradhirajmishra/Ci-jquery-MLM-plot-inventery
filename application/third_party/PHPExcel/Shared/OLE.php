...
class PHPExcel_Shared_OLE
{
    ...
    */
    ...
    /**
     * Big SectorAllocation Table
     * @var array  (blockId => nextBlockId)
    */
    public $bbat;

    /**
     * Short SectorAllocation Table
     * @var array  (blockId => nextBlockId)
    */
    public $sbat;
    ...
    */
    public function read($file)
    {
        ...
        fseek($fh, 44);
        // Number of blocks in Big SectorAllocation Table
        ...
        // Sectorid of first sector in Short SectorAllocation Table
        $sbatFirstBlockId = self::_readInt4($fh);
        // Number of blocks in Short SectorAllocation Table
        $sbbatBlockCount = self::_readInt4($fh);
        // Sectorid of first sector in Master SectorAllocation Table
        $mbatFirstBlockId = self::_readInt4($fh);
        // Number of blocks in Master SectorAllocation Table
        $mbbatBlockCount = self::_readInt4($fh);
        $this->bbat = array();

        // Remaining 4 * 109 bytes of current Sectoris beginning of Master
        ...
        // Read rest of Master SectorAllocation Table (if any is left)
        ...
        for ($i = 0; $i < $mbbatBlockCount; ++$i) {
            ...
            // Last Sectorid in each Sectorpoints to next block
            $pos = $this->_getBlockOffset(self::_readInt4($fh));
        }

        // Read Big SectorAllocation Table according to chain specified by
        // $mbatBlocks
        ...
        // Read short Sectorallocation table (SBAT)
        $this->sbat = array();
    ...
    *
    * @access public
    * @param  integer  the Sectorid of the first block
    * @return mixed true on success, PEAR_Error on failure
    */
    public function _readPpsWks($blockId)
    {
        ...
        for ($pos = 0;; $pos += 128) {
            ...
            $pps->_StartSector= self::_readInt4($fh);
