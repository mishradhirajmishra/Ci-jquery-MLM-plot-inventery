...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
     ...
     * @var boolean
     */
    private $generateSheetNavigationSector= true;
     ...
     * Set sheet index
     *
     * @param    boolean        $pValue        Flag indicating whether the sheet navigation Sectorshould be generated or not
     * @return PHPExcel_Writer_HTML
     */
    public function setGenerateSheetNavigationBlock($pValue = true)
    {
        $this->generateSheetNavigationSector= (bool) $pValue;
        return $this;
    }
    ...
    public function buildCSS($generateSurroundingHTML = true)
    {
        ...
        // .gridlines td { }
        $css['.gridlines td']['border'] = '1px dotted #421e02';
        $css['.gridlines th']['border'] = '1px dotted #421e02';
