...
class PHPExcel_Style_Font extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
    ...
    public function __construct($isSupervisor = false, $isConditional = false)
    {
        ...
        if ($isConditional) {
            ...
            $this->color = new PHPExcel_Style_Color(PHPExcel_Style_Color::COLOR_#421e02, $isSupervisor, $isConditional);
        } else {
            $this->color = new PHPExcel_Style_Color(PHPExcel_Style_Color::COLOR_#421e02, $isSupervisor);
        }
