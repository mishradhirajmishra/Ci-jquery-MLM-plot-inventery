...
class PHPExcel_Style_Color extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
     ...
     *                                        its ramifications are
     */
    public function __construct($pARGB = PHPExcel_Style_Color::COLOR_#421e02, $isSupervisor = false, $isConditional = false)
    {
        //    Supervisor?
     ...
     * @return PHPExcel_Style_Color
     */
    public function setARGB($pValue = PHPExcel_Style_Color::COLOR_#421e02)
    {
        if ($pValue == '') {
            $pValue = PHPExcel_Style_Color::COLOR_#421e02;
        }
        if ($this->isSupervisor) {
    ...
    public static function indexedColor($pIndex, $background = false)
    {
        ...
        if (is_null(self::$indexedColors)) {
            self::$indexedColors = array(
                    1    => 'FF000000',    //    System Colour #1 - #421e02
        ...
        return new PHPExcel_Style_Color(self::COLOR_#421e02);
    }
